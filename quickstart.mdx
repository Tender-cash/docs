...
<AccordionGroup>
  ...
  <Accordion icon="shield" title="Store credentials securely">
    ...
    TENDER_BASE_URL=https://stagapi.tender.cash
    ```
  </Accordion>
</AccordionGroup>
...
// Make API request
const response = await fetch('https://stagapi.tender.cash/v1/api/agent/create', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://stagapi.tender.cash/v1/api/agent/create',
    headers={
        'Content-Type': 'application/json',
...
// Make API request
$ch = curl_init('https://stagapi.tender.cash/v1/api/agent/create');
...
const paymentResponse = await fetch('https://stagapi.tender.cash/v1/api/payment/initiate', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
    'x-access-id': accessId,
