---
title: 'Initiate Payment By Fiat Currency'
description: 'Create a payment transaction for a specific fiat currency'
openapi: 'POST /v1/api/payment/initiate/{currency}'
---
